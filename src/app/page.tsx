    ...
    <main className={`min-h-screen w-full relative bg-[#0B0914] text-[#f5f5f5] transition-opacity duration-1000 ${!showPreloader ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <div className="space-y-12 mt-auto mb-16 md:mb-12">
                <Reveal delay={200}>
                  ...
                  <div className="flex gap-4 p-4 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md w-fit">
                    <a href="/projects/juresep" target="_blank" className="w-10 h-10 rounded-full flex items-center justify-center text-white hover:bg-white/20 hover:scale-110 transition-all">
              ...
              <Reveal delay={200}>
                <div className="mt-12 flex flex-col items-end space-y-8">
                  <p className="text-xl md:text-2xl text-gray-200 font-medium">
                    ...
                    <a href="/cv.pdf" download="Saifudin_Juhri_CV.pdf" className="group relative inline-flex items-center justify-center px-10 py-4 bg-transparent border-2 border-white/80 text-white font-bold uppercase tracking-[0.2em] text-sm rounded-full overflow-hidden transition-transform hover:scale-105">
                      <span className="relative z-10 group-hover:text-black transition-colors duration-500">
                        Download CV
                      </span>
                      <div className="absolute inset-0 h-full w-full bg-white transform scale-y-0 origin-bottom group-hover:scale-y-100 transition-transform duration-500 ease-in-out z-0"></div>
                    </a>
                </div>
              </Reveal>
            </div>
      ...
      <section id="projects" className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-32">
          {[
            { title: "Nobox.Chat", desc: "A fast, secure, and modern chat application built with Flutter and Firebase. Features real-time messaging, end-to-end encryption, and a sleek user interface.", tags: ["Flutter", "Server", "C#"], img: "/assets/images/nobox-logo.png", link: "/projects/nobox-chat" },
            { title: "Absensiku", desc: "Employee attendance tracking system utilizing location services. Simplifies time tracking, leave requests, and generates comprehensive reports.", tags: ["Flutter", "Dart", "DB"], img: "/assets/images/app_icon_new.png", link: "/projects/absensiku", reverse: true },
            { title: "Juresep", desc: "Digital recipe book and cooking assistant with an elegant UI. Browse recipes, save favorites, and follow step-by-step guides.", tags: ["Flutter", "REST API"], img: "/assets/images/juresep-logo.jpg", link: "/projects/juresep" }
          ].map((project, idx) => (
            <Reveal key={idx}>
