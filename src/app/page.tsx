        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Reveal delay={200}>
            <div className="text-center w-full leading-[0.85] tracking-tighter">
              <h1 className="text-[12vw] md:text-[10vw] font-bold text-white uppercase block">
                Saifudin
              </h1>
              <h1 className="text-[12vw] md:text-[10vw] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#FFD700] uppercase block">
                Juhri
              </h1>
            </div>
